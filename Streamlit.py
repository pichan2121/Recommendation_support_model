...
uploaded_files = st.file_uploader("Upload model and item data according to the link below", accept_multiple_files=True)
...
st.markdown(
        """
        ** Link 1👈
        - https://drive.google.com/file/d/1m8b3yNZCo_fDARW_QDOYibQozPXmzDdT/view?usp=share_link
        
        ** Link 2👈
        - https://drive.google.com/file/d/1UF5yCPnLP5ee8r2RpkEu8doZ9K86CjQL/view?usp=share_link
        
        ** Link 3👈
        - https://drive.google.com/file/d/1gKtQQ-enhWMhrkcaCWBaahk6bkfUm5oE/view?usp=share_link"""  
    )
...
def data_frame_demo():
    ...
    with st.container():
            ...
            clicked="Enter"  
    if len(item)!=0:
            st.write("### 2. Here are some recommended items reference to other User whose are similar with your rating history:")
            user_id = item
